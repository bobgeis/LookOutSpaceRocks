var Elm = Elm || { Native: {} };
Elm.Asteroids = Elm.Asteroids || {};
Elm.Asteroids.make = function (_elm) {
   "use strict";
   _elm.Asteroids = _elm.Asteroids || {};
   if (_elm.Asteroids.values)
   return _elm.Asteroids.values;
   var _op = {},
   _N = Elm.Native,
   ...
   var viewBase = function (base) {
      return function () {
         var diameter = base.r * 2;
         return $Graphics$Collage.move({ctor: "_Tuple2"
                                       ,_0: base.x
                                       ,_1: base.y})($Graphics$Collage.rotate($Basics.degrees(base.ang))($Graphics$Collage.toForm(A3($Graphics$Element.image,
         diameter,
         diameter,
         base.imageName))));
      }();
   };
   var drawTransport = function (transport) {
      return $Graphics$Collage.move({ctor: "_Tuple2"
                                    ,_0: transport.x
                                    ,_1: transport.y})($Graphics$Collage.rotate(transport.ang - $Basics.degrees(90))($Graphics$Collage.toForm(A3($Graphics$Element.image,
      16,
      16,
      transport.imageName))));
   };
   var viewTransports = function (transports) {
   ...
   var drawRock = function (rock) {
      return $Graphics$Collage.move({ctor: "_Tuple2"
                                    ,_0: rock.x
                                    ,_1: rock.y})($Graphics$Collage.filled($Color.lightBrown)($Graphics$Collage.circle(rock.r)));
   };
   var viewRocks = function (rocks) {
      return $Graphics$Collage.group(A2($List.map,
      drawRock,
      rocks));
   };
   var drawBullet = function (bullet) {
      return function () {
         var age = bullet.age;
         var color = _U.cmp(age,
         0.4) < 0 ? $Color.white : _U.cmp(age,
         0.8) < 0 ? $Color.lightBlue : $Color.darkBlue;
         return $Graphics$Collage.move({ctor: "_Tuple2"
                                       ,_0: bullet.x
                                       ,_1: bullet.y})($Graphics$Collage.filled(color)($Graphics$Collage.circle(bullet.r)));
      }();
   };
   var viewBullets = function (bullets) {
      return $Graphics$Collage.group(A2($List.map,
      drawBullet,
      bullets));
   };
   var foldCatches = F2(function (loot,
   _v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
   ...
   game) {
      return function () {
         var rotateBase = F2(function (b,
         a) {
            return _U.replace([["ang"
                               ,b.ang + a]],
            b);
         });
         var t = input.tick;
         var base$ = rotateBase(game.base)(20 * t);
         var guild$ = rotateBase(game.guild)(-15 * t);
         return _U.replace([["guild"
                            ,guild$]
                           ,["base",base$]],
         game);
      }();
   ...
   var isColliding = F2(function (obj1,
   obj2) {
      return _U.cmp(Math.pow(obj1.x - obj2.x,
      2) + Math.pow(obj1.y - obj2.y,
      2),
      Math.pow(obj1.r + obj2.r,
      2)) < 1;
   });
   var listCollide = F2(function (list,
   a) {
      return function () {
         var filter = F2(function (a,
         b) {
            return A2(isColliding,
            a,
            b) ? $Maybe.Just({ctor: "_Tuple2"
                             ,_0: a
                             ,_1: b}) : $Maybe.Nothing;
         });
   ...
   var getSeed = function (junk) {
      return $Random.initialSeed($Basics.floor(junk));
   };
   var getProbFromSeed = function (seed) {
      return A2($Random.generate,
      A2($Random.$float,0,1),
      seed);
   };
   var quickProb = function (junk) {
      return $Basics.fst(getProbFromSeed(getSeed(junk)));
   };
   var initialSeed = $Random.initialSeed(5);
   var startBase = {_: {}
                   ,ang: 37
                   ,imageName: "images/Grey2.png"
                   ,r: 40
                   ,vx: 0
                   ,vy: 0
                   ,x: -200
                   ,y: 200};
   var startGuild = _U.replace([["imageName"
                                ,"images/DomeBuilder0.png"]
                               ,["x",200]
                               ,["y",-200]
                               ,["r",30]
                               ,["ang",172]],
   ...
   var transportSpeed = 50;
   var lootRadius = 3;
   var lootMaxAge = 20;
   var drawLoot = function (loot) {
      return function () {
         var ageRatio = loot.age / lootMaxAge;
         var imageName = function () {
            var _v6 = loot.kind;
            switch (_v6.ctor)
            {case "Crystal":
               return _U.cmp(ageRatio,
                 0.2) < 0 ? "images/Small3.png" : _U.cmp(ageRatio,
                 0.5) < 0 ? "images/Small2.png" : _U.cmp(ageRatio,
                 0.8) < 0 ? "images/Small1.png" : "images/Small0.png";
               case "Lifeboat":
         ...
         return $Graphics$Collage.move({ctor: "_Tuple2"
                                       ,_0: loot.x
                                       ,_1: loot.y})($Graphics$Collage.rotate(loot.ang)($Graphics$Collage.toForm(A3($Graphics$Element.image,
         6,
         6,
         imageName))));
      }();
   };
   var viewLoot = function (loot) {
      return $Graphics$Collage.group(A2($List.map,
      drawLoot,
      loot));
   };
   var Crystal = {ctor: "Crystal"};
   var Lifeboat = {ctor: "Lifeboat"};
   var explosionInitialRadius = 11;
   var createExplosion = function (obj) {
      return {_: {}
             ,age: 0
             ,r: explosionInitialRadius
             ,vx: 0
             ,vy: 0
             ,x: obj.x
             ,y: obj.y};
   };
   var explosionGrowthRate = 110;
   var explosionMaxAge = 0.2;
   var updateExplosion = F3(function (input,
   game,
   explosion) {
      return function () {
         var t = input.tick;
         var r$ = explosion.r + t * explosionGrowthRate;
         var age$ = explosion.age + t;
         return _U.cmp(age$,
         explosionMaxAge) > 0 ? $Maybe.Nothing : $Maybe.Just(_U.replace([["age"
                                                                         ,age$]
                                                                        ,["r"
                                                                         ,r$]],
         explosion));
   ...
   var updateExplosions = F2(function (input,
   game) {
      return function () {
         var explosions$ = A2($List.filterMap,
         A2(updateExplosion,input,game),
         game.explosions);
         return _U.replace([["explosions"
                            ,explosions$]],
         game);
      }();
   });
   var drawExplosion = function (explosion) {
      return function () {
         var ageRatio = explosion.age / explosionMaxAge;
         var color = _U.cmp(ageRatio,
         0.2) < 0 ? $Color.lightBlue : _U.cmp(ageRatio,
         0.5) < 0 ? $Color.white : _U.cmp(ageRatio,
         0.8) < 0 ? $Color.lightRed : $Color.darkRed;
         return $Graphics$Collage.move({ctor: "_Tuple2"
                                       ,_0: explosion.x
                                       ,_1: explosion.y})($Graphics$Collage.filled(color)($Graphics$Collage.circle(explosion.r)));
      }();
   };
   var viewExplosions = function (explosions) {
      return $Graphics$Collage.group(A2($List.map,
      drawExplosion,
      explosions));
   };
   var bulletReload = 0.1;
   var bulletMaxAge = 1.0;
   var bulletSpeed = 500;
   var spawnBullet = F2(function (player,
   game) {
      return function () {
         var vec = getVec(player.ang);
         return {_: {}
                ,age: 0
                ,r: 2
   ...
   var rockVChange = 50;
   var launchLifeboats = function (trans) {
      return function () {
         var dvy = rockVChange * (-0.5 + quickProb(trans.x * trans.vx));
         var dvx = rockVChange * (-0.5 + quickProb(trans.x * trans.vx));
         var lb1 = {_: {}
                   ,age: 0
                   ,ang: 0
                   ,kind: Lifeboat
                   ,r: lootRadius
                   ,vang: $Basics.degrees(-100)
                   ,vx: trans.vx + dvx
                   ,vy: trans.vy + dvy
                   ,x: trans.x
                   ,y: trans.y};
         return _L.fromArray([lb1
                             ,_U.replace([["vx"
                                          ,trans.vx - dvx]
                                         ,["vy",trans.vy - dvy]],
                             lb1)]);
   ...
   var createCrystal = function (obj) {
      return _U.cmp(quickProb(obj.vx * obj.vy),
      0.3) > 0 ? $Maybe.Nothing : function () {
         var dvy = rockVChange * (-0.5 + quickProb(obj.y * obj.vy));
         var dvx = rockVChange * (-0.5 + quickProb(obj.x * obj.vx));
         return $Maybe.Just({_: {}
                            ,age: 0
                            ,ang: 0
                            ,kind: Crystal
                            ,r: lootRadius
                            ,vang: $Basics.degrees(270)
                            ,vx: obj.vx + dvx
                            ,vy: obj.vy + dvy
                            ,x: obj.x
                            ,y: obj.y});
   ...
   var getSmallerSize = function (size) {
      return function () {
         switch (size.ctor)
   ...
   var calve = function (rock) {
      return function () {
         ...
         {case "Small":
            return _L.fromArray([]);}
         return function () {
            var dvy = rockVChange * (-0.5 + quickProb(rock.y));
            var dvx = rockVChange * (-0.5 + quickProb(rock.x));
            return _L.fromArray([_U.replace([["size"
                                             ,getSmallerSize(rock.size)]
                                            ,["vx",rock.vx + dvx]
                                            ,["vy",rock.vy - dvy]
                                            ,["r"
                                             ,getRadius(getSmallerSize(rock.size))]],
                                rock)
                                ,_U.replace([["size"
                                             ,getSmallerSize(rock.size)]
                                            ,["vx",rock.vx - dvx]
   ...
   var updateCollisions = F2(function (input,
   game) {
      return function () {
         var colls = A2($List.concatMap,
         listCollide(game.rocks),
         game.bullets);
         var bulletNotColl = function (bullet) {
         ...
         var bullets$ = A2($List.filter,
         bulletNotColl,
         game.bullets);
         var rockNotColl = function (rock) {
            return $Basics.not(A2($List.any,
            function (_v13) {
               return function () {
                  switch (_v13.ctor)
         ...
         var rocks$ = A2($List.filter,
         rockNotColl,
         game.rocks);
         var calves = A2($List.concatMap,
         function (_v17) {
            return function () {
               switch (_v17.ctor)
               {case "_Tuple2":
   ...
   var startGame = {_: {}
                   ...
                   ,guild: startGuild
                   ,hiscores: {ctor: "_Tuple3"
                              ,_0: 0
                              ,_1: 0
                              ,_2: 0}
                   ,loot: _L.fromArray([])
                   ,lootCaught: {ctor: "_Tuple2"
                                ,_0: 0
                                ,_1: 0}
                   ,lootSaved: {ctor: "_Tuple2"
                               ,_0: 0
                               ,_1: 0}
                   ,player: startPlayer
                   ,rocks: startRocks
                   ...
                   ,state: Pause
                   ,time: 0
                   ,transports: _L.fromArray([])
                   ,transportsAway: 0};
   var maybePause = F2(function (input,
   game) {
      return function () {
         var player = game.player;
         return player.dead ? function () {
            var $ = game.hiscores,
            x = $._0,
            y = $._1,
            z = $._2;
            var z$ = game.transportsAway;
            var $ = game.lootSaved,
            x$ = $._0,
            y$ = $._1;
            var hiscores$ = {ctor: "_Tuple3"
                            ,_0: A2($Basics.max,x,x$)
                            ,_1: A2($Basics.max,y,y$)
                            ,_2: A2($Basics.max,z,z$)};
            return _U.replace([["hiscores"
                               ,hiscores$]],
            startGame);
         }() : _U.replace([["state"
                           ,Pause]],
   ...
   var Play = {ctor: "Play"};
   var maybeUnpause = F2(function (input,
   game) {
      return _U.eq(input.space,
      false) ? game : _U.replace([["state"
                                  ,Play]],
      game);
   });
   ...
   halfW = $._0,
   halfH = $._1;
   var isOffscreen = function (obj) {
      return _U.cmp($Basics.abs(obj.x),
      halfW) > 0 ? true : _U.cmp($Basics.abs(obj.y),
      halfH) > 0 ? true : false;
   };
   var foldTransports = F3(function (input,
   transport,
   _v29) {
      return function () {
         switch (_v29.ctor)
         {case "_Tuple2":
            return isOffscreen(transport) ? {ctor: "_Tuple2"
                                            ,_0: _v29._0
                                            ,_1: _v29._1 + 1} : function () {
                 var t = input.tick;
                 var transport$ = _U.replace([["x"
                                              ,transport.x + transport.vx * t]
                                             ,["y"
                                              ,transport.y + transport.vy * t]],
                 transport);
                 var list$ = A2($List._op["::"],
                 transport$,
                 _v29._0);
                 return {ctor: "_Tuple2"
                        ,_0: list$
   ...
   game) {
      return function () {
         var $ = A3($List.foldl,
         foldTransports(input),
         {ctor: "_Tuple2"
         ,_0: _L.fromArray([])
         ,_1: game.transportsAway},
         game.transports),
         transports$ = $._0,
         transportsAway$ = $._1;
         var colls = A2($List.concatMap,
         listCollide(game.rocks),
         transports$);
         var transNotColl = function (trans) {
            return $Basics.not(A2($List.any,
            function (_v33) {
               return function () {
                  switch (_v33.ctor)
         ...
         colls);
         var lifeboats = A2($List.concatMap,
         function (_v41) {
            return function () {
               switch (_v41.ctor)
               {case "_Tuple2":
         ...
         colls);
         var transports$$ = A2($List.filter,
         transNotColl,
         transports$);
         return _U.replace([["transports"
                            ,transports$$]
                           ,["transportsAway"
                            ,transportsAway$]
                           ,["explosions"
   ...
   var wrapX = function (x) {
      return _U.cmp(x,
      halfW) > 0 ? x - gameW : _U.cmp(x,
      0 - halfW) < 0 ? x + gameW : x;
   };
   var wrapY = function (y) {
      return _U.cmp(y,
      halfH) > 0 ? y - gameH : _U.cmp(y,
      0 - halfH) < 0 ? y + gameH : y;
   };
   var moveObj = F2(function (t,
   obj) {
      return _U.replace([["x"
                         ,wrapX(obj.x + t * obj.vx)]
                        ,["y"
                         ,wrapY(obj.y + t * obj.vy)]],
      obj);
   });
   var updatePlayer = F2(function (input,
   game) {
      return _U.eq(game.player.dead,
      true) ? game : function () {
         var damp = function (t) {
            return 1 - 0.25 * t;
         };
         var delAng = $Basics.degrees($Basics.toFloat(input.arrows.x) * 5.0);
         var thrust = function () {
            var _v45 = input.arrows.y;
            switch (_v45)
            {case -1: return -50;
               case 0: return 0;
               case 1: return 200;}
         ...
         isColliding(player),
         game.rocks);
         var explosions$ = dead$ ? A2($List._op["::"],
         createExplosion(player),
         game.explosions) : game.explosions;
         var vec = getVec(player.ang);
         var reload$ = function () {
            var _v46 = player.reload;
            switch (_v46)
            {case 0:
               return input.space ? bulletReload : 0;}
            return A2($Basics.max,
            0,
            _v46 - t);
         }();
         var bullets$ = $Basics.not(_U.eq(reload$,
         bulletReload)) ? game.bullets : A2($List._op["::"],
         A2(spawnBullet,player,game),
         game.bullets);
         var vx$ = player.vx + vec.x * thrust * t;
         var vy$ = player.vy + vec.y * thrust * t;
         var $ = function () {
            var $ = game.lootSaved,
            x2 = $._0,
            y2 = $._1;
            ...
            return A2(isColliding,
            player,
            game.base) ? {ctor: "_Tuple2"
                         ,_0: {ctor: "_Tuple2"
                              ,_0: x1
                              ,_1: 0}
                         ,_1: {ctor: "_Tuple2"
                              ,_0: x2
                              ,_1: y1 + y2}} : A2(isColliding,
            player,
            game.guild) ? {ctor: "_Tuple2"
                          ,_0: {ctor: "_Tuple2"
                               ,_0: 0
                               ,_1: y1}
                          ,_1: {ctor: "_Tuple2"
         ...
         lootCaught$ = $._0,
         lootSaved$ = $._1;
         var player$ = moveObj(t)(_U.replace([["vx"
                                              ,vx$ * damp(t)]
                                             ,["vy",vy$ * damp(t)]
   ...
   var updateBullet = F3(function (input,
   game,
   bullet) {
      return function () {
         var t = input.tick;
         var age$ = bullet.age + t;
         return _U.cmp(age$,
         bulletMaxAge) > 0 ? $Maybe.Nothing : $Maybe.Just(moveObj(t)(_U.replace([["age"
                                                                                 ,age$]],
         bullet)));
      }();
   });
   var updateBullets = F2(function (input,
   game) {
      return function () {
         var bullets$ = A2($List.filterMap,
         A2(updateBullet,input,game),
         game.bullets);
         return _U.replace([["bullets"
                            ,bullets$]],
         game);
   ...
   var updateRocks = F2(function (input,
   game) {
      return function () {
         var t = input.tick;
         var rocks$ = A2($List.map,
         moveObj(t),
         game.rocks);
         return _U.replace([["rocks"
                            ,rocks$]],
         game);
      }();
   });
   var updateLoot = F2(function (input,
   game) {
      return function () {
         ...
         catches = $._0,
         loot$ = $._1;
         var lootCaught$ = A3($List.foldl,
         foldCatches,
         game.lootCaught,
         catches);
         var t = input.tick;
         var loot$$ = $List.filter(function (r) {
            return _U.cmp(r.age,
            lootMaxAge) < 0;
         })($List.map(function (r) {
            return _U.replace([["age"
                               ,r.age + t]
                              ,["ang",r.ang + r.vang * t]],
            r);
         })(A2($List.map,
         moveObj(t),
         loot$)));
         return _U.replace([["loot"
                            ,loot$$]
                           ,["lootCaught",lootCaught$]],
         game);
      }();
   });
   var makeRandomTransport = F2(function (input,
   game) {
      return function () {
         var imageName = _U.cmp(quickProb(game.time * 10),
         0.5) > 0 ? "images/Civ1.png" : "images/Builder3.png";
         var coord = quickProb(game.time * 9) - 0.5;
         var side = quickProb(game.time * 8);
         var $ = _U.cmp(side,
         0.25) < 0 ? {ctor: "_Tuple2"
                     ,_0: coord * gameW
                     ,_1: halfH} : _U.cmp(side,
         0.5) < 0 ? {ctor: "_Tuple2"
                    ,_0: coord * gameW
                    ,_1: 0 - halfH} : _U.cmp(side,
         0.75) < 0 ? {ctor: "_Tuple2"
                     ,_0: halfW
                     ,_1: coord * gameH} : {ctor: "_Tuple2"
                                           ,_0: 0 - halfW
                                           ,_1: coord * gameH},
         x = $._0,
         y = $._1;
         ...
         0.25) < 0 ? {ctor: "_Tuple2"
                     ,_0: 0
                     ,_1: 0 - transportSpeed} : _U.cmp(side,
         0.5) < 0 ? {ctor: "_Tuple2"
                    ,_0: 0
                    ,_1: transportSpeed} : _U.cmp(side,
         0.75) < 0 ? {ctor: "_Tuple2"
                     ,_0: 0 - transportSpeed
                     ,_1: 0} : {ctor: "_Tuple2"
                               ,_0: transportSpeed
         ...
         vy = $._1;
         var ang = _U.cmp(side,
         0.25) < 0 ? $Basics.degrees(270) : _U.cmp(side,
         0.5) < 0 ? $Basics.degrees(90) : _U.cmp(side,
         0.75) < 0 ? $Basics.degrees(180) : 0;
         return {_: {}
                ,ang: ang
                ,imageName: imageName
                ,r: 10
   ...
   var makeRandomRock = F2(function (input,
   game) {
      return function () {
         var vy = (quickProb(game.time * 6) - 0.5) * rockVChange * 2;
         var vx = (quickProb(game.time * 5) - 0.5) * rockVChange * 2;
         var coord = quickProb(game.time * 4) - 0.5;
         var side = quickProb(game.time * 3);
         var $ = _U.cmp(side,
         0.25) < 0 ? {ctor: "_Tuple2"
                     ,_0: coord * gameW
                     ,_1: halfH} : _U.cmp(side,
   ...
   var timerSpawns = F2(function (input,
   game) {
      return _U.eq(game.time,
      input.currentTime) ? game : function () {
         var rocks$ = _U.cmp(quickProb(game.time * 2),
         0.5) > 0 ? game.rocks : A2($List._op["::"],
         A2(makeRandomRock,input,game),
         game.rocks);
         var transports$ = _U.cmp(quickProb(game.time * 7),
         0.5) > 0 ? game.transports : A2($List._op["::"],
         A2(makeRandomTransport,
         input,
         game),
         game.transports);
   ...
   game) {
      ...
      Pause) ? A2(maybeUnpause,
      input,
      game) : input.ctrl ? A2(maybePause,
      input,
      game) : timerSpawns(input)(updateCollisions(input)(updateTransports(input)(updateLoot(input)(updateExplosions(input)(updateBase(input)(updateRocks(input)(updateBullets(input)(updatePlayer(input)(game)))))))));
   });
   var viewSky = $Graphics$Collage.toForm(A3($Graphics$Element.fittedImage,
   gameW,
   gameH,
   "images/stars.jpg"));
   var view = F2(function (_v47,
   game) {
      return function () {
         switch (_v47.ctor)
         {case "_Tuple2":
   ...
   var tick = A2($Signal._op["<~"],
   $Time.inSeconds,
   $Time.fps(35));
   var allInputs = $Signal.sampleOn(tick)(A2($Signal._op["~"],
   A2($Signal._op["~"],
   A2($Signal._op["~"],
   A2($Signal._op["~"],
   A2($Signal._op["<~"],
   ...
   _elm.Asteroids.values = {_op: _op
                           ...
                           ,Large: Large
                           ,Huge: Huge
                           ,rockVChange: rockVChange
                           ,bulletSpeed: bulletSpeed
                           ,bulletMaxAge: bulletMaxAge
                           ,bulletReload: bulletReload
                           ,explosionMaxAge: explosionMaxAge
                           ,explosionGrowthRate: explosionGrowthRate
                           ,explosionInitialRadius: explosionInitialRadius
                           ,Lifeboat: Lifeboat
                           ,Crystal: Crystal
                           ,lootMaxAge: lootMaxAge
                           ...
                           ,startBase: startBase
                           ,startGuild: startGuild
                           ,initialSeed: initialSeed
                           ,quickProb: quickProb
                           ,getProbFromSeed: getProbFromSeed
                           ,getSeed: getSeed
                           ,wrapX: wrapX
                           ,wrapY: wrapY
                           ,moveObj: moveObj
                           ...
                           ,listCollide: listCollide
                           ,getVec: getVec
                           ,getRadius: getRadius
                           ,getSmallerSize: getSmallerSize
                           ,updateGame: updateGame
                           ,maybeUnpause: maybeUnpause
                           ...
                           ,foldTransports: foldTransports
                           ,launchLifeboats: launchLifeboats
                           ,updateExplosions: updateExplosions
                           ,updateExplosion: updateExplosion
                           ,updateRocks: updateRocks
                           ,updateBase: updateBase
                           ,updateLoot: updateLoot
                           ,foldCatches: foldCatches
                           ,updateCollisions: updateCollisions
                           ,calve: calve
                           ,createExplosion: createExplosion
                           ,createCrystal: createCrystal
                           ,timerSpawns: timerSpawns
                           ,makeRandomTransport: makeRandomTransport
                           ,makeRandomRock: makeRandomRock
                           ,view: view
                           ,viewSky: viewSky
                           ,viewBullets: viewBullets
                           ,drawBullet: drawBullet
                           ,viewRocks: viewRocks
                           ,drawRock: drawRock
                           ,viewPlayer: viewPlayer
                           ,viewExplosions: viewExplosions
                           ,drawExplosion: drawExplosion
                           ,viewLoot: viewLoot
                           ,drawLoot: drawLoot
                           ,viewTransports: viewTransports
                           ,drawTransport: drawTransport
                           ,viewBase: viewBase
                           ,viewText: viewText
                           ,viewPauseText: viewPauseText
                           ,drawText: drawText
                           ,viewHiscores: viewHiscores};
   return _elm.Asteroids.values;
};
